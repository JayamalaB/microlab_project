...
module.exports = sequelize.define('BookingRequest', {
  booking_request_id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
  ...
  total_attempts_count: { type: DataTypes.TINYINT, defaultValue: 0 },
...
}, { tableName: 'booking_requests', timestamps: false });
